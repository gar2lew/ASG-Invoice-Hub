...
# Define the old beforeEach block (from the HEAD version we just checked out)
...
if old_block not in content:
    print('ERROR: Old beforeEach block not found in the file.')
    # Let's try to see what the file looks like around the beforeEach
    lines = content.split('\n')
